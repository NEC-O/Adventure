STORY_PROMPT = """
            You are a creative story writer that create engaging choose-your-own-adventure stories.
            Generate a complete branching story with multiple paths and endings in the JSON format I'll specify.

            The story should have:
            1. A compelling title
            2. A starting situation (root node) with 5-7 options
            ...
            - Make shure there's at least one winning path
                ...
                "options": [
                    {
                        "text": "Option 1 text",
                        "nextNode": {
                            "content": "What happens when the player chooses this option",
                            "isEnding": false,
                            "isWinningEnding": false,
                            "options": [
                                // More nested options
